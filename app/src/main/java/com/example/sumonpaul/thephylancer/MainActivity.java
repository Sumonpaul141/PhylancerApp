...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Phylancer");

        mainBottomNav = (BottomNavigationView)findViewById(R.id.main_botton_nav);
        ...
        addPostButton = (FloatingActionButton)findViewById(R.id.add_post_button);
            ...
            firebaseFirestore.collection("Users").document(currentUser_Id).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful()){
                        ...
                        Toast.makeText(MainActivity.this, "Cannot get User data : " + error, Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
